...
Drive a SH1106 based OLED from MicroPython with I2C or SPI bus. The driver is based on the FrameBuffer implementation so it inherits of all the drawing primitives.

The SH1106 class also implements special methods for controlling the display.

Finally the driver is plateform agnostic and should work with any microcontroler running MicroPython.

![](docs/_static/sh1106-example.jpg)
...
@robert-hh added a few functions and changed the existing ones so it matches better the need for a project.

@mchobby reworked the folder structure and added some ressources. 
...
![SH1106 I2C wiring to Raspberry-Pico](docs/_static/i2c-sh1106-to-pico.jpg)
...
if reset is connected. Otherwise it's a No-Op.
